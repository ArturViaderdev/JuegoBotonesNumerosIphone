...
class ViewController: UIViewController {
    ...
    var maxcolumnas = 3 //Número de columnas
    ...
    func crearbotones()
    {
        ...
        while cont<maxbotones
        {
          ...
          /*  switch(columnascreadas)
            ...
            myButton.frame = CGRect(x: (75*(columnascreadas)) + 25, y: (cont + 1) * 100, width: 50, height: 50)
    ...
    @objc func cambiatiempo()
    {
        ...
        var vsegun = segundos - (minutos * 60)
        ...
        if(partida)
        {
            ...
            if(vsegun>9)
            {
                ltiempo.text = "\(minutos):\(vsegun)"
            }
            else
            {
                ltiempo.text = "\(minutos):0\(vsegun)"
            }
    ...
    override func viewDidLoad() {
        ...
        maxcolumnas = (Int(tamanopantalla.width) - 25) / 75
        empezarpartida()
